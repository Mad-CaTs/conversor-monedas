...
<div align="center">
    ...
    <img alt="Static Badge" src="https://img.shields.io/badge/API-ExchangeRate-red">
...
![Alternative text](/resources/Screenshot_1.jpg)
...
2. **Clone your fork locally**:
   ...
   ```bash
   git clone https://github.com/Mad-CaTs/conversor-monedas.git
   ```
